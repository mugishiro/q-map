  ...
  return (
    <div className="settings-header" ref={menuRef}>
      ...
      >
        ...
        {showLabel && <span className="settings-trigger-label">{label}</span>}
      </button>
      {open && (
        <div className={popoverClass}>
          ...
          <div className="settings-menu">
            <div className="settings-menu-item has-submenu" role="button" tabIndex={0}>
              ...
              <span className="settings-menu-trailing">
                <span className="settings-menu-meta">{themeLabel}</span>
            ...
            <div className="settings-menu-item has-submenu" role="button" tabIndex={0}>
              ...
              <span className="settings-menu-label">グリッド</span>
              <span className="settings-menu-trailing">
                <span className="settings-menu-meta">{gridLabel}</span>
                <span className="settings-menu-arrow">›</span>
              </span>
              <div className="settings-submenu" role="menu">
                <button
            ...
            >
              ...
              <span className="settings-menu-label">LLM 設定</span>
              <span className="settings-menu-trailing">
                <span className="settings-menu-arrow">›</span>
              </span>
            </button>
        ...
        <div className="modal-backdrop" onClick={() => setShowAuth(false)}>
          <div className="modal-card stack gap-m" onClick={(e) => e.stopPropagation()} style={{ minWidth: "360px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <button className="icon-btn" aria-label="閉じる" title="閉じる" onClick={() => setShowAuth(false)}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <path d="M6 6l12 12M18 6L6 18" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
                </svg>
              </button>
